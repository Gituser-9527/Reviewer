...
export const ticket: HumanReviewTicket = {
  ...
  feedback: { id: 'decision-1', reviewerId: 'reviewer-a', agentDecision: 'MANUAL_REVIEW', finalDecision: 'REJECT', feedbackType: 'FALSE_NEGATIVE', comment: '', falsePositive: false, falseNegative: true, createdAt: '2026-01-01T00:00:00.000Z' },
};
